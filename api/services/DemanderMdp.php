...
include_once ('C:\wamp64\www\ws-php-fg\tracegps\modele\DAO.php');
include_once ('C:\wamp64\www\ws-php-fg\tracegps\modele\Outils.php'); // ajouté pour utiliser Outils::creerMdp()
...
{	$msg = "Erreur : méthode HTTP incorrecte.";
    ...
    if ($pseudo == "") {
        ...
        if ($unUtilisateur == null) {
            ...
            // génération d’un nouveau mdp aleatoire via Outils::creerMdp()
