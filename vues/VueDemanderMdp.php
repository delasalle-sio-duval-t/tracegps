			...
			<div data-role="content">
				...
				{ ?>
    				<form name="form1" id="form1" action="index.php?action=DemanderMdp" data-ajax="false" method="post" data-transition="<?php echo $transition; ?>">
    					<p>Pour obtenir un nouveau mot de passe, indiquez votre pseudo ainsi que votre mail.</p>
                        ...
                        <div data-role="fieldcontain" class="ui-hide-label">
                            <input type="email" name="txtAdrMail" placeholder="Adresse mail" required pattern="^[^@\s]+@[^@\s]+\.[^@\s]+$" value="<?php echo $adrMail; ?>">
                        </div>
